...
const Footer = () => {
  return (
    <footer className="mt-8">
      {/* Benefits section before footer (optional based on page) */}
        ...
        <div className="container mx-auto p-4">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <div className="flex items-center">
                <span className="mr-1">›</span>
                <Link to="#" className="hover:underline">Cancellation & Refund Policy</Link>
              </div>
              <div className="flex items-center">
                <span className="mr-1">›</span>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span>+1-888-928-1369</span>
              </div>
              <div className="flex items-center">
                <span className="mr-2">✉️</span>
                <span>info@airflightcart.us</span>
              </div>
              <div className="flex items-center">
                <span className="mr-2">🌐</span>
                <span>airflightcart.us</span>
              </div>
            </div>
          </div>
