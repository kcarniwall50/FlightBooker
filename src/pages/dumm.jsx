...
const Home = () => {
  ...
  const handleSearchSubmit = () => {
    ...
    // Build the URL path
    let urlPath = `${fromCode}${departDate}${toCode}`;
    if (tripType === 'roundTrip' && returnDate) {
      urlPath += returnDate;
    }
    
    // Add traveler info
    urlPath += `${passengers.adults}${passengers.children}${passengers.infants}`;
    ...
    const searchUrl = `https://search.airflightcart.us/flights/${urlPath}`;
            ...
            <div className="mb-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div className="relative">
                  ...
                  {/* Calendar Dropdown */}
                  {showCalendar && (
                    <div className="absolute top-full mt-1 left-0 right-0 bg-white shadow-lg rounded-lg z-20 border border-gray-200">
