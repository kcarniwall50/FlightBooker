...
// Section 2: State and Data  
  ...
  const handlePassengerChange = (type, operation) => {
    setPassengers(prev => {
      // For infants, enforce maximum limit of 2
      if (type === 'infants' && operation === 'increase' && prev.infants >= 2) {
        return prev; // Don't increase if already at max of 2 infants
      }
      ...
      const totalPassengers = 
        ...
        updatedPassengers.infants;
      
      setSearchParams(prevParams => ({ ...prevParams, passengers: totalPassengers }));
            ...
            <div className="mb-2">
              ...
              { /* Section 8: Render Part 2 - Date Inputs & Calendar   */}
                ...
                <div className="relative">
                  ...
                  {/* Calendar Dropdown */}
{showCalendar && (
  <div ref={calendarRef}   className="absolute top-full mt-1 left-0 right-0 bg-white shadow-lg rounded-lg z-20 border border-gray-200" style={{ width: '500px', maxWidth: '100vw' }}>
...
<div className="flex justify-between items-center mb-4">
  ...
  <div className="flex items-center space-x-2">
    ...
    <button 
      className={`p-1 border border-gray-300 rounded-md ${passengers.infants >= 2 ? 'opacity-50 cursor-not-allowed' : ''}`}
